...
<sub> Nota que aquí se reflejan procesos no herramientas tecnológicas. Haz el ejercicio de entender cual herramienta del stack corresponde a cual parte del proceso<sub/>
